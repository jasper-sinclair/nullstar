...
namespace attack{
  int king_dir[8] = {8,9,1,-7,-8,-9,-1,7};
  ...
  bitboard bishop_att[n_sqs];
  bitboard diag_by_sq[n_sqs];
  bitboard diag[15];
  ...
  bitboard files_by_sq[n_sqs];
  bitboard fill_up_att[8][64];
  bitboard first_rank_att[8][64];
  bitboard in_between_sqs[n_sqs][n_sqs];
  bitboard king_att[n_sqs];
  bitboard knight_att[n_sqs];
  bitboard pawn_att[n_colors][n_sqs];
  bitboard ranks_by_sq[n_sqs];
  bitboard ray_att[n_dirs][n_sqs];
  bitboard rook_att[n_sqs];
