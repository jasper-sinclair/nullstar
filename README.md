...
The current public release, Nullstar 027, uses a self-contained 768x256
...
companion files. Nullstar 027 also aligns quantized inference with the trainer
and includes the search and transposition-table corrections developed since
the initial public release.

## Repository layout

- `BUILD_INFO.json`: exact current build, UCI identity, NNUE epoch, and hash
  relationship;
...
[`release notes`](docs/NULLSTAR_027_RELEASE_NOTES.md) directly.
