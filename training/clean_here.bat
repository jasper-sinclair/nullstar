...
call :remove "smoke\training_sparse_stm_smoke_1m.offsets.u64"
call :remove "smoke\training_sparse_stm_smoke_1m.offsets.u64.part"
call :remove "smoke\training_sparse_stm_smoke_1m.offsets.u64.json"
call :remove "smoke\training_sparse_stm_smoke_1m.offsets.u64.json.part"
call :remove "smoke\training_sparse_stm_prefix_1m.offsets.u64"
call :remove "smoke\training_sparse_stm_prefix_1m.offsets.u64.part"
call :remove "smoke\training_sparse_stm_prefix_1m.offsets.u64.json"
call :remove "smoke\training_sparse_stm_prefix_1m.offsets.u64.json.part"
...
call :remove "training_sparse_stm.offsets.u64"
call :remove "training_sparse_stm.offsets.u64.part"
call :remove "training_sparse_stm.offsets.u64.json"
call :remove "training_sparse_stm.offsets.u64.json.part"
goto :complete
